...
resource "aws_iam_role_policy_attachment" "demo_eks_kong_nodegroup_access_AmazonEKS_CNI_Policy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKS_CNI_Policy"
  role       = aws_iam_role.demo_eks_cluster_node_access.name
}

resource "aws_iam_role_policy_attachment" "demo_eks_kong_nodegroup_access_AmazonEC2ContainerRegistryReadOnly" {
